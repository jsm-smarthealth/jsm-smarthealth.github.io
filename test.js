...
<section class="bg-white team-style6 builder-bg padding-110px-tb xs-padding-60px-tb" id="team">
    ...
    <!-- Blog Section - TO BE ADDED-->
<section class="padding-110px-tb xs-padding-60px-tb bg-white builder-bg blog-style2" id="blog">
    <div class="container">
        <!-- section title -->
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                <h2 class="section-title-large sm-section-title-medium xs-section-title-large text-dark-gray font-weight-600 alt-font margin-three-bottom xs-margin-fifteen-bottom tz-text">LATEST BLOGS</h2>
                <div class="text-medium width-60 margin-lr-auto md-width-70 sm-width-100 tz-text margin-thirteen-bottom  xs-margin-nineteen-bottom">Content FROM IODA MEDIUM BLOG</div>
            </div>
        </div>
        <!-- end section title -->
...
<!-- Working script for Medium Blog -->
<script type="text/javascript">
        // Script to generate blog content form MEDIUM blog
        $(function () {
            var $content = $('#blogContent');
            var data = {
                rss_url: 'https://blog.indiaopendata.com/feed'
            };
            $.get('https://api.rss2json.com/v1/api.json', data, function (response) {
                if (response.status == 'ok') {
                    var customHtml = '';
